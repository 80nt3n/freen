(() => {
    ...
    */
    ...
    function create_image(img_data) {
        ...
        var string_vector = 0 // processing vector ciphertext locate b64 padding
        var cipher_text_length = img_data.length
        var b64_char_list = ["A", "Q", "g", "w", "B", "R", "h", "x", "C", "S", "i", "y", "D", "T", "j", "z",
        ...
        for (k = 0; k < 300; k++) {
            for (i = 0; i < 400; i++) {
                if (string_vector <= cipher_text_length) {
                    ...
                    g = 180
                    b = r
                   // console.log(img_data.indexOf(61 + 43))
                   // console.log(r, g, b, img_data[string_vector])
                }
                else {
                    //r = Math.floor(Math.random() * 64); //base64
                    b64_char = b64_char_list[Math.floor(Math.random() * 64)];
                    
                    r = b64_char.charCodeAt(0) - 43
